...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    user_course_statuses: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiExamExam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::exam.exam'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    questions: Schema.Attribute.Component<'exam.question', true>;
...
export interface ApiRecommendationResultRecommendationResult
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recommendedAt: Schema.Attribute.DateTime;
...
export interface ApiUserActivityLogUserActivityLog
  ...
  attributes: {
    accessedAt: Schema.Attribute.DateTime;
    course: Schema.Attribute.Relation<'manyToOne', 'api::course.course'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiUserCourseStatusUserCourseStatus
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lastAccessed: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-course-status.user-course-status'
...
export interface ApiUserProgressUserProgress
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    difficulty: Schema.Attribute.Enumeration<['easy', 'medium', 'hard']>;
    durationSpent: Schema.Attribute.BigInteger;
    ...
    organizationID: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    reaction: Schema.Attribute.Enumeration<['like', 'neutral', 'dislike']>;
    score: Schema.Attribute.Decimal;
