            ...
            <div className="px-6 h-[90px] max-h-[90px] flex items-center justify-start border-b bg-gradient-to-r from-purple-600 to-pink-600 flex-shrink-0">
              <div className="flex items-center space-x-3">
                <div className="relative w-14 h-14 rounded-full bg-white/20 flex items-center justify-center overflow-hidden">
                  <Image src={'/images/student.webp'} alt="avatar" width={100} height={100} className='rounded-full h-full w-full object-cover' />
                </div>
                <div>
                  <p className="font-semibold text-white">{user?.username || 'Học viên'}</p>
                  <p className="text-sm text-purple-100">Học viên</p>
                </div>
              </div>
            </div>
